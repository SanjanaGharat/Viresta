	...
	return (
		<section className="latest-collections mt-6">
			...
			<HeaderDashed
				head1="LATEST"
				head2="COLLECTIONS"
				paragraph="Step into the new season with Viresta's Latest Collection! Featuring the freshest trends and timeless essentials, our curated selection is designed to elevate your style and meet all your needs."
			/>
